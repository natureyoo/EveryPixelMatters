...
_C.MODEL.ADV.SEPERATE_DIS = True
...
_C.MODEL.ADV.COND_EXPAND = 0
_C.MODEL.ADV.COND_SMOOTH = False
_C.MODEL.ADV.COND_WARMUP_ITER = 0
_C.MODEL.ADV.COND_ALPHA = 0.0
_C.MODEL.ADV.COND_CONF = 0.5
_C.MODEL.ADV.COND_CLASS = False
_C.MODEL.ADV.COND_REG = CN()
_C.MODEL.ADV.COND_REG.LEFT = False
_C.MODEL.ADV.COND_REG.TOP = False
